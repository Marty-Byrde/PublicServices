...
import { SvgIconProps } from "@/typings/Shared/Icons/typings"

export default function UniversityIcon({ className }: SvgIconProps = {}) {
  return (
    <svg key={className} fill="#000000" className={twMerge('h-4 w-4', className)} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
