  ...
  return (
    <div className='px-4 pb-8'>
      <div className='flex gap-4 justify-center my-4 mb-8 flex-col md:flex-row items-center'>
        <Text content='Answers for: ' textSize='text-2xl' darkColor='dark:text-gray-200' color='text-gray-700'/>
        <Text content={quizzId.toString()} textSize='text-2xl' darkColor='dark:text-secondary-content' color='text-primary' className='text-center'/>
      </div>
